...
(function() {
  ...
  define(['jquery', 'browserdetect', 'underscore', 'jquery.cookie'], function($, browserdetect, _) {
    var WH, clickEventHandler;
    clickEventHandler = (function() {
      function clickEventHandler(wh, opts) {
        if (opts == null) {
          opts = {};
        }
      ...
      clickEventHandler.prototype.bindBodyClicked = function(doc) {
        return $(doc).on('click', this.clickBindSelector, this.elemClicked);
      };

      clickEventHandler.prototype.elemClicked = function(e, options) {
    ...
    return WH = (function() {
      ...
      WH.prototype.init = function(opts) {
        ...
        this.clickHandler = new clickEventHandler(this, opts);
      ...
      WH.prototype.bindBodyClicked = function(doc) {
        this.clickHandler.bindBodyClicked(doc);
        return $(doc).on('click', this.clickBindSelector, this.elemClicked);
      };
