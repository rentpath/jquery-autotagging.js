(function() {
  ...
  define(['jquery', 'browser-detect', 'underscore', './click_handler', './select_change_handler', 'jquery.cookie'], function($, browserdetect, _, ClickEventHandler, SelectChangeHandler) {
    var WH;
    return WH = (function() {
